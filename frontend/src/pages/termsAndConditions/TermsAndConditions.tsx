...
import { TERMS_AND_CONDITIONS_STRING } from '../../utils/constants';

const TermsAndConditions = () => {
    return (
        <>
            <div className="flex justify-between w-2/3 mx-auto">
                <p className="font-normal">{TERMS_AND_CONDITIONS_STRING}</p>
                <AppPath />
            </div>
                ...
                <div className="w-1/2 max-w-full overflow-hidden pb-24">
                    <div>
                        ...
                        <p className="pb-2 text-trueGray-500">
                            ...
                            website, Auction App accessible at
                            sampleauctionapp.com.
                        </p>
                        ...
                        <p className="pb-2 text-trueGray-500">
                            ...
                            sampleauctionapp.com and/or its licensors own all
                        ...
                        <p className="pt-6 pb-3 text-xl">Restrictions</p>
                        ...
                        <ul className="list-disc text-trueGray-500">
                            <li>
                        ...
                        <p className="pt-2 pb-2 text-trueGray-500">
                            Certain areas of this Website are restricted from
                            being access by you and sampleauctionapp.com may
                        ...
                        <p className="pt-6 pb-3 text-xl">Your Content</p>
                        ...
                        <p className="pb-2 text-trueGray-500">
                            ...
                            sampleauctionapp.com a non-exclusive, worldwide
                        ...
                        <p className="pb-2 text-trueGray-500">
                            ...
                            sampleauctionapp.com reserves the right to remove
                            any of Your Content from this Website at any time
                            without notice.
                        </p>

                        <p className="pt-6 pb-3 text-xl">No warranties</p>

                        <p className="pb-2 text-trueGray-500">
                            This Website is provided "as is," with all faults,
                            and sampleauctionapp.com express no representations
                            or warranties, of any kind related to this Website
                            or the materials contained on this Website. Also,
                        ...
                        <p className="pb-2 text-trueGray-500">
                            In no event shall sampleauctionapp.com, nor any of
                            ...
                            liability is under contract.  sampleauctionapp.com,
                        ...
                        <p className="pt-6 pb-3 text-xl">Indemnification</p>

                        <p className="pb-2 text-trueGray-500">
                            You hereby indemnify to the fullest extent
                            sampleauctionapp.com from and against any and/or all
                        ...
                        <p className="pt-6 pb-3 text-xl">Severability</p>
                        ...
                        <p className="pt-6 pb-3 text-xl">Variation of Terms</p>

                        <p className="pb-2 text-trueGray-500">
                            sampleauctionapp.com is permitted to revise these
                        ...
                        <p className="pb-2 text-trueGray-500">
                            The sampleauctionapp.com is allowed to assign,
                        ...
                        <p className="pt-6 pb-3 text-xl">Entire Agreement</p>

                        <p className="pb-2 text-trueGray-500">
                            These Terms constitute the entire agreement between
                            sampleauctionapp.com and you in relation to your use
                        ...
                        <p className="pb-2 text-trueGray-500">
                            ...
                            accordance with the laws of the State of ba, and you
                            submit to the non-exclusive jurisdiction of the
                            state and federal courts located in ba for the
